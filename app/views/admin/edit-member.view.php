                ...
                ?>
                    <form method="POST" action="edit-member">
                        ...
                        <div class="form-group">
                            ...
                            <input type="name" name="name" value="<?php echo $memberData->name;?>" class="form-control"
                                placeholder="Enter your name"><br>
                        </div>
                        <div class="form-group">
                            <label for="email "> Email address</label>
                            <input type="email" name="email" value="<?php echo $memberData->email;?>"
                                class="form-control" placeholder="Enter your email"><br>
                        </div>
                        <div class="form-group">
                            <label for="phone "> Phone number </label>
                            <input type="text" name="phone" value="<?php echo $memberData->phone;?>"
                                class="form-control" placeholder="Enter your phone No."><br>
                        </div>
                        <!-- <div class="form-group">
